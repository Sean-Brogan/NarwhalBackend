...
public class Dataloader implements ApplicationRunner {
	...
	for (int i = 0; i < users.size(); i++){
        ...
        //                                    frequency       dosage  deliveryMethod      expirationDate  
	...
	diagnosisRecords.add(new Diagnosis("Asthma", "Patient came in with narrowed airways."));
        ...
        indexRecords.add(new MedicalRecord(22, 5, 3, new Date()));
        medicalTestRecords.add(new MedicalTest("C-protein Blood test", "Results are within the normal range."));

        indexRecords.add(new MedicalRecord(23, 5, 3, new Date()));
        ...
        indexRecords.add(new MedicalRecord(21, 4, 2, new Date()));
        ...
        indexRecords.add(new MedicalRecord(19, 2, 2, new Date()));
        ...
        medicationRecords.add(new Medication("Once Weekly",     4,      "IV",    new Date(8/17/2018)));

        indexRecords.add(new MedicalRecord(26, 3, 4, new Date()));  
        medicationRecords.add(new Medication("Once Daily",     1,      "Orally",    new Date(3/17/2018)));

        indexRecords.add(new MedicalRecord(27, 3, 4, new Date()));  
        medicationRecords.add(new Medication("Biweekly",     2,      "IM”,    new Date(4/17/2018)));

        indexRecords.add(new MedicalRecord(28, 3, 4, new Date()));  
        medicationRecords.add(new Medication("Three times daily",     2,      "Orally",    new Date(12/17/2017)));

        indexRecords.add(new MedicalRecord(20, 4, 4, new Date()));  
        medicationRecords.add(new Medication("Once daily",     1,      "Orally”,    new Date(1/17/2018)));
        ...
        indexRecords.add(new MedicalRecord(29, 3, 5, new Date())); 
